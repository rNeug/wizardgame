...
void HP::create(GLuint program) {
  ...
  std::array positions{
      ...
      glm::vec2{-02.5f, +07.5f}, glm::vec2{-09.5f, +04.5f},
      glm::vec2{-03.5f, +04.5f}, glm::vec2{-09.5f, -01.5f},
      glm::vec2{-06.0f, -01.5f}, glm::vec2{-09.5f, -04.5f},
      glm::vec2{-03.5f, -01.5f}, glm::vec2{-03.5f, -04.5f},

      
      glm::vec2{+02.5f, +6.0f}, glm::vec2{+04.5f, +07.5f},
      glm::vec2{+04.5f, +04.5f}, 

      
      glm::vec2{+04.5f, -01.5f}, glm::vec2{+04.5f, -03.5f}, 
      glm::vec2{-12.5f, -03.5f}, glm::vec2{-12.5f, -01.5f}, 
...
void HP::paint(const GameData &gameData) {
...
void HP::update(GameData const &gameData, float deltaTime) {
  // Rotate
